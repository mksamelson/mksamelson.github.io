...
erroneous data.  Only one feature, user_spendings, had any suspicious data a handful (27) negative values.  I eliminated these values as erroneous, substituting an NA for
the negative values.
